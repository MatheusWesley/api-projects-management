...
describe('Error Scenarios and Edge Cases Integration Tests', () => {
  ...
  describe('HTTP Protocol and Content Handling Errors', () => {
    ...
    it('should handle missing and incorrect Content-Type headers', async () => {
      const testUser = await testFactory.createTestUser();
      const validData = JSON.stringify({ name: 'Test Project', description: 'Test' });

      const contentTypeScenarios = [
        // Missing Content-Type
        { headers: {}, expectedStatuses: [201, 400, 415, 422] },
        // Wrong Content-Type
        { headers: { 'Content-Type': 'text/plain' }, expectedStatuses: [201, 400, 415, 422] },
        { headers: { 'Content-Type': 'application/xml' }, expectedStatuses: [201, 400, 415, 422] },
        { headers: { 'Content-Type': 'multipart/form-data' }, expectedStatuses: [201, 400, 415, 422] },
        // Malformed Content-Type
        { headers: { 'Content-Type': 'application/' }, expectedStatuses: [201, 400, 415, 422] },
        { headers: { 'Content-Type': 'invalid-content-type' }, expectedStatuses: [201, 400, 415, 422] }
      ];
    ...
    it('should handle empty request bodies where data is expected', async () => {
      ...
      const emptyBodyScenarios = [
        { method: 'POST', url: 'http://localhost/projects', expectedStatus: 400 },
        { method: 'POST', url: 'http://localhost/auth/register', expectedStatus: 400 },
        { method: 'POST', url: 'http://localhost/auth/login', expectedStatus: 400 }
      ];
  ...
  describe('Validation Error Scenarios', () => {
    it('should handle comprehensive validation errors for user registration', async () => {
      const validationScenarios = [
        // Email validation
        { data: { email: '', name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        { data: { email: 'invalid', name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        { data: { email: '@example.com', name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        { data: { email: 'test@', name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        { data: { email: 'test@.com', name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        
        // Name validation
        { data: { email: 'test@example.com', name: '', password: 'Password123!', role: 'developer' }, field: 'name' },
        { data: { email: 'test@example.com', name: 'a', password: 'Password123!', role: 'developer' }, field: 'name' },
        { data: { email: 'test@example.com', name: 'a'.repeat(101), password: 'Password123!', role: 'developer' }, field: 'name' },
        
        // Password validation
        { data: { email: 'test@example.com', name: 'Test', password: '', role: 'developer' }, field: 'password' },
        { data: { email: 'test@example.com', name: 'Test', password: '1234567', role: 'developer' }, field: 'password' },
        { data: { email: 'test@example.com', name: 'Test', password: 'short', role: 'developer' }, field: 'password' },
        
        // Role validation
        { data: { email: 'test@example.com', name: 'Test', password: 'Password123!', role: '' }, field: 'role' },
        { data: { email: 'test@example.com', name: 'Test', password: 'Password123!', role: 'invalid' }, field: 'role' },
        { data: { email: 'test@example.com', name: 'Test', password: 'Password123!', role: 'superuser' }, field: 'role' },
        
        // Missing fields
        { data: { name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        { data: { email: 'test@example.com', password: 'Password123!', role: 'developer' }, field: 'name' },
        { data: { email: 'test@example.com', name: 'Test', role: 'developer' }, field: 'password' },
        { data: { email: 'test@example.com', name: 'Test', password: 'Password123!' }, field: 'role' },
        
        // Type errors
        { data: { email: 123, name: 'Test', password: 'Password123!', role: 'developer' }, field: 'email' },
        { data: { email: 'test@example.com', name: 123, password: 'Password123!', role: 'developer' }, field: 'name' },
        { data: { email: 'test@example.com', name: 'Test', password: 123, role: 'developer' }, field: 'password' },
        { data: { email: 'test@example.com', name: 'Test', password: 'Password123!', role: 123 }, field: 'role' }
      ];
    ...
    it('should handle comprehensive validation errors for project creation', async () => {
      ...
      const validationScenarios = [
        ...
        { data: { name: 'Test', description: 'a'.repeat(1001) }, field: 'description' }, // Description too long
    ...
    it('should handle comprehensive validation errors for work item creation', async () => {
      ...
      const validationScenarios = [
        ...
        // Description validation
        { data: { title: 'Test', type: 'task', description: 'a'.repeat(2001) }, field: 'description' }, // Too long
        { data: { title: 'Test', type: 'task', description: 123 }, field: 'description' }, // Wrong type
        
        // Priority validation
        { data: { title: 'Test', type: 'task', priority: 'invalid' }, field: 'priority' },
        { data: { title: 'Test', type: 'task', priority: 123 }, field: 'priority' },
        
        // Story points validation
        { data: { title: 'Test', type: 'task', storyPoints: 0 }, field: 'storyPoints' }, // Too low
        { data: { title: 'Test', type: 'task', storyPoints: 101 }, field: 'storyPoints' }, // Too high
        { data: { title: 'Test', type: 'task', storyPoints: 'invalid' }, field: 'storyPoints' }, // Wrong type
        
        // Estimated hours validation
        { data: { title: 'Test', type: 'task', estimatedHours: 0 }, field: 'estimatedHours' }, // Too low
        { data: { title: 'Test', type: 'task', estimatedHours: 1001 }, field: 'estimatedHours' }, // Too high
        { data: { title: 'Test', type: 'task', estimatedHours: 'invalid' }, field: 'estimatedHours' } // Wrong type
      ];
  ...
  describe('Business Logic Error Scenarios', () => {
    it('should handle invalid work item status transitions', async () => {
      const testUser = await testFactory.createTestUser();
      const testProject = await testFactory.createTestProject(testUser);
      const testWorkItem = await testFactory.createTestWorkItem(testProject, testUser);
      ...
      for (const transition of invalidTransitions) {
        const response = await app.handle(
          new Request(`http://localhost/items/${testWorkItem.workItem.id}/status`, {
            method: 'PATCH',
            headers: {
              'Authorization': `Bearer ${testUser.token}`,
              'Content-Type': 'application/json'
    ...
    it('should handle operations on non-existent resources', async () => {
      ...
      const nonExistentOperations = [
        ...
        { method: 'PUT', url: 'http://localhost/projects/non-existent-id', body: { name: 'Updated' } },
        { method: 'DELETE', url: 'http://localhost/projects/non-existent-id' },
        
        // Work item operations
        { method: 'GET', url: 'http://localhost/items/non-existent-id' },
        { method: 'PUT', url: 'http://localhost/items/non-existent-id', body: { title: 'Updated' } },
        { method: 'DELETE', url: 'http://localhost/items/non-existent-id' },
        { method: 'PATCH', url: 'http://localhost/items/non-existent-id/status', body: { status: 'done' } },
        { method: 'PATCH', url: 'http://localhost/items/non-existent-id/priority', body: { priorityOrder: 1 } },
        
        // Project-scoped operations
        { method: 'GET', url: 'http://localhost/projects/non-existent-id/items' },
        { method: 'POST', url: 'http://localhost/projects/non-existent-id/items', body: { title: 'Test', type: 'task' } },
        { method: 'GET', url: 'http://localhost/projects/non-existent-id/kanban' },
        { method: 'GET', url: 'http://localhost/projects/non-existent-id/backlog' }
      ];
