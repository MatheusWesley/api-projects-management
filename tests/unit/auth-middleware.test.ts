...
describe('Authentication Middleware', () => {
	...
	describe('authMiddleware', () => {
		it('should allow access with valid token', async () => {
			const app = createTestApp(authMiddleware, ({ user }) => ({
				userId: user.userId,
				role: user.role,
			}))
	...
	describe('requireRole', () => {
		...
		it('should deny access for user without required role', async () => {
			const app = createTestApp(requireRole(['admin']), ({ user }) => ({
				role: user.role,
			}))
	...
	describe('requireAdmin', () => {
		it('should allow access for admin user', async () => {
			const app = createTestApp(requireAdmin, ({ user }) => ({
				role: user.role,
			}))
	...
	describe('requireManagerOrAdmin', () => {
		it('should allow access for manager user', async () => {
			const app = createTestApp(requireManagerOrAdmin, ({ user }) => ({
				role: user.role,
			}))
