...
describe('User Schemas', () => {
	...
	it('should validate LoginSchema correctly', () => {
		...
		expect(Value.Check(LoginSchema, { ...validLogin, email: 'invalid' })).toBe(
			false,
		)
	})
...
describe('Project Schemas', () => {
	it('should validate CreateProjectSchema correctly', () => {
		...
		expect(Value.Check(CreateProjectSchema, { name: 'Test Project' })).toBe(
			true,
		) // Description optional
		expect(Value.Check(CreateProjectSchema, { description: 'No name' })).toBe(
			false,
		) // Name required
	})
...
describe('Work Item Schemas', () => {
	...
	it('should validate UpdateWorkItemPrioritySchema correctly', () => {
		...
		expect(Value.Check(UpdateWorkItemPrioritySchema, invalidPriority)).toBe(
			false,
		)
	})
})
