 ...
 */
export const requireOwnershipOrAdmin = (getUserIdFromParams: (context: any) => string) => (app: Elysia) =>
 ...
 */
export const extractProjectOwnerIdFromParams = async (context: Context, projectRepository: any) => {
