...
export const CreateWorkItemSchema = Type.Object({
  ...
  storyPoints: Type.Optional(Type.Integer({ 
    minimum: 1, 
    maximum: 100,
    description: 'Story points estimation'
  })),
  estimatedHours: Type.Optional(Type.Integer({ 
    minimum: 1, 
    maximum: 1000,
...
export type UpdateWorkItemPriorityData = Static<typeof UpdateWorkItemPrioritySchema>;