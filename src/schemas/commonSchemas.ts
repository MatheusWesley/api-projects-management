...
export const SuccessResponseSchema = <T extends TSchema>(dataSchema: T) => Type.Object({
  data: dataSchema,
...
export const PaginatedResponseSchema = <T extends TSchema>(itemSchema: T) => Type.Object({
