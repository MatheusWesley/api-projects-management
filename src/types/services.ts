...
import type { WorkItem, CreateWorkItemData, UpdateWorkItemData, KanbanBoard } from './workItem.js';
...
export interface IWorkItemService {
  createWorkItem(data: CreateWorkItemData, projectId: string, userId: string): Promise<WorkItem>;
  ...
  updateWorkItemStatus(id: string, status: 'todo' | 'in_progress' | 'done', userId: string): Promise<WorkItem>;
  getBacklog(projectId: string, userId: string): Promise<WorkItem[]>;
  updatePriority(id: string, priorityOrder: number, userId: string): Promise<WorkItem>;
  assignWorkItem(id: string, assigneeId: string, userId: string): Promise<WorkItem>;
}
...
export interface ISprintService {
  ...
  updateSprint(id: string, data: UpdateSprintData, userId: string): Promise<Sprint>;
