  ...
  .use(swagger({
    documentation: {
      info: {
        ...
        description: 'A comprehensive project management API built with Bun and Elysia',
        version: '1.0.0'
      },
      tags: [
      ...
      servers: [
        {
          ...
          description: config.nodeEnv === 'development' ? 'Development server' : 'Production server'
        }
      ]
    }
  }))
...
console.log(`📚 Documentation: http://${app.server?.hostname}:${app.server?.port}/swagger`);
