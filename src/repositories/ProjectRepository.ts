...
export class ProjectRepository implements IProjectRepository {
  ...
  async create(projectData: CreateProjectData & { ownerId: string }): Promise<Project> {
    const id = generateId();
  ...
  async findByIdWithOwner(id: string): Promise<(Project & { ownerName: string; ownerEmail: string }) | null> {
    const stmt = this.db.prepare(`
