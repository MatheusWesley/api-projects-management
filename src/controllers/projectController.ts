		...
		return (
			new Elysia({ prefix: '/projects' })
				...
				.get(
					...
					async ({ user, set }) => {
						try {
							const projects = await this.projectService.listUserProjects(
								user.userId,
							)
					...
					},
					{
						response: {
							200: t.Object({
									...
									projects: t.Array(
										t.Object({
											...
											description: t.Optional(
												t.String({ examples: ['Project description'] }),
											),
								...
								message: t.String({
									examples: ['Projects retrieved successfully'],
								}),
							}),
						},
						detail: {
							...
							description:
								'Get all projects that the authenticated user has access to. Requires valid JWT token in Authorization header.',
							tags: ['Projects'],
							security: [{ bearerAuth: [] }],
						},
					},
							...
							201: t.Object({
								...
								data: t.Object({
									project: t.Object({
										...
										description: t.Optional(
											t.String({ examples: ['A modern e-commerce platform'] }),
										),
										ownerId: t.String({ examples: ['user-123'] }),
										status: t.String({ examples: ['active'] }),
										createdAt: t.String({
								...
								message: t.String({
									examples: ['Project created successfully'],
								}),
							}),
						},
						detail: {
							...
							description:
								'Create a new project for the authenticated user. The user becomes the project owner.',
							tags: ['Projects'],
							security: [{ bearerAuth: [] }],
							examples: {
								'Basic project': {
